...
## Implementation {auto-animate="true" .hidden}
...
data.frame(
  id = c("Structuring Variable", "Data", "Features", "Feature Values"),
  marble = c("Bag", "Marble", "Color", "Binary"),
  shape = c("Object Category", "Object Exemplar", "Shape, Color, Texture, Size, etc.", "Categorical")
) |>
  kbl(
    align = "c",
    col.names = NULL,
  ...
  add_header_above(c(" " = 1, "Marble Example" = 1, "Shapes Example")) |>
