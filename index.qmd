...
- Präzision ($\alpha + \beta$) beschreibt wie homogen oder heterogen die Farbverteilung innerhalb der Beutel ist
  - Hohe Werte $\rightarrow$ gemischte Farben in Beutel (Verteilung streut nur gering um ihren Mittelwert, kleine Varianz)
...
- Abbildungen sind in der Hierarchie von links nach rechts zu lesen 
  - Daten
  - Posteriore Verteilungen über die Wahscheinlichkeit eine schwarze Murmel zu ziehen für jeden Murmelbeutel
  - Posteriore Verteilung der Hyperparameter 

- Modell bildet unsere Intuition ab $\rightarrow$ Modell schlussfolgert für achten Beutel eine Wahrscheinlichkeit $\theta_8$ von nahezu 1
- Wie konnte das Modell diese genaue Vorhersage machen?
- Dafür auf die höchste Ebene schauen $\rightarrow$ Kleine Werte für Precision-Parameter $\alpha + \beta$ U-förmige Verteilung; Modell schlussfolgert, dass Beutel homogen bezüglich Farbe sind
- Zusammendfassend: Durch Observationen auf niedrigere Ebene konnte auf höherere Abstraktionsebene eine Generalisierung entstehen und auf Basis dieser Generalisierung als Prior können Präzise Vorhersagen für wenige Datenpunkte neuen Beute gemacht werden

- Zu Zweiter Abbildung (hin und her switchen, um Kontrast zu zeigen)
- Es verändern sich auf Ebene der Modellparameter im wesentliche zwei Aspekte
  - Kleinerer mittlere Wahrscheinlichkeit eine schwarze Murmel zu ziehen $\alpha / (\alpha + \beta)$
  - Höheres Präzisionsparameter $\alpha + \beta$ $\rightarrow$ Modell hat gelernt, dass Beutel heterogen sind
- Und weil Beutel heterogen sind, kann auf Ebene zwei für den achten Beutel keine gute Vorhersage gemacht werden, weil der einen Datenpunkt uns fast keine Information liefert
...
## Anwendung auf die Nomen-Generalisation
...
- HBM weist gleichen **Präferenzmuster wie die trainierten Kinder** auf
...
## Literatur
  ...
  [1]: /figures/single/dotplot_mu0.5_phi0.8_1.svg
  [2]: /figures/single/dotplot_mu0.5_phi0.8_2.svg
  [3]: /figures/single/dotplot_mu0.5_phi0.8_3.svg
  [4]: /figures/single/dotplot_mu0.5_phi0.8_4.svg
  [5]: /figures/single/dotplot_mu0.5_phi0.8_5.svg
  [6]: /figures/single/dotplot_mu0.5_phi0.8_6.svg
  [7]: /figures/single/dotplot_mu0.5_phi0.8_7.svg
  [8]: /figures/single/dotplot_mu0.5_phi0.8_8.svg
  [9]: /figures/hyperpriors.svg
  [10]: /figures/panel_mu0.5_phi0.8.svg
  [11]: /figures/panel_mu0.2_phi20.svg
  [12]: /img/pen.png
